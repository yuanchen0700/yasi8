...
# ---------------- 配置 ----------------
MD_DIR = Path(r'D:\a.create\_MY_GIT_lib\GITEE\yasi\yasi-rdtli\md\雅思听力8讲')
...
def extract_display_title(h1: str, h2_first: str, fname: str) -> str:
    ...
    if h1:
        ...
        for p in parts:
            if '雅思-' in p or '雅思听力全解' in p or re.match(r'^雅思听力全解8讲\s*[\-－]?\s*\d*$', p):
                continue
            # 提取 " - N" 之后的部分作为课程名
...
<header class="topbar">
  ...
  <div class="topbar-right">
    <a href="index.html" style="font-size:13px;color:#2c5cdc;font-weight:600;white-space:nowrap;">🏠 总目录</a>
    <a href="qa-tl-index.html" style="font-size:13px;color:#2c5cdc;font-weight:600;white-space:nowrap;">💡 问答精要</a>
...
<div class="layout">
  <aside class="col-left">
    ...
    <h3>速查</h3>
    <ul>
      <li><a href="qa-tl-index.html">问答精要版</a></li>
    </ul>
  </aside>
  <main class="col-main">
    {content}
...
def build_doc_index() -> list:
    docs = []
    for md_file in sorted(MD_DIR.glob('听力课程_*.md')):
...
def main():
    ...
    if converted:
        ...
        index_html = HTML_TEMPLATE.format(
            ...
            doc_list=items,
            sub_section='',
            content='<h1>雅思听力 8 讲</h1><p>从左侧选择课程开始学习。<br>想要精炼问答版？<a href="qa-tl-index.html">👉 查看听力问答精要</a></p>',
